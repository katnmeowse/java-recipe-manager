...
public class Cookbook {
	...
	public boolean equals(Object obj) {
		if (obj instanceof Cookbook == false) {
			return false;
		}
		if (this == obj) {
			return true;
		}
		Cookbook rhs = (Cookbook) obj;
		return new EqualsBuilder().appendSuper(super.equals(obj)).append(name,
				rhs.name).append(category, rhs.category).isEquals();

	}

	@Override
	public int hashCode() {
		return new HashCodeBuilder(12, 32).append(name).append(category)
				.toHashCode();
