...
public class InstructionSet {
	...
	public boolean equals(Object obj) {
		if (obj instanceof InstructionSet == false) {
			return false;
		}
		if (this == obj) {
			return true;
		}
		InstructionSet rhs = (InstructionSet) obj;
		return new EqualsBuilder().appendSuper(super.equals(obj)).append(name,
				rhs.name).append(instruction, rhs.instruction).isEquals();

	}

	@Override
	public int hashCode() {
		return new HashCodeBuilder(16, 36).append(name).append(instruction)
				.toHashCode();
	...
	public String toString() {
		return new ToStringBuilder(this).append("name", name).append(
				"ingredientList", instruction).toString();
	}
